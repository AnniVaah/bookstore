...
function AddBook(props){
    ...
    return(
        <>
            <Button variant='outlined' onClick={handleOpen}>Add a book</Button>
            <Dialog open={open}>
                <DialogTitle>New book</DialogTitle>
                <DialogContent>
                    <TextField name='title' value={book.title} onChange={inputChanged} margin='dense' label='Description' fullWidth/>
